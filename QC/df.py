...
def mse(v1, v2):
    ...
    return loss
#######################################################################
# Define system, set up simulation parameters
#######################################################################
...
#######################################################################
# Define auxiliary basis for DF, get DF integrals
#######################################################################
...
### Dump DF ints to file ###
np.savetxt('dferi.dat',ints_3c2e.flatten())

### Read Decoded integrals from file ###
...
#######################################################################
# Build full integral array from DF integrals
#######################################################################
...
### Save full DF reconstructed integrals to file ###
np.savetxt("df.12bps.full.dat",df_eri.flatten())

### Get exact full TEI tensor ###
eri = mol.intor('int2e')

## Evaluate distortion bw DF and full TEI ###
